...
### Project Structure
```
├── Andrewnijmehsapplication.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── Andrewnijmehsapplication            - Application components folder
...
Inter-SemiBold
Inter-Bold
Inter-ExtraBold```# miracle-mobile
